...
> **R:** Porque los #include hacen que se agreguen los contenidos de las distintas librerias que se ponen despues del include, trayendo muchas funciones, datos y otras cosas que la libreria contiene.
...
> **R:** Porque el preprocesador borra todos los comentarios, por eso no se puede encontrar ningun comentario en programa.i
...
> **R:** El primer no dió salida pero el sedungod si: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:** Comunican de que archivo y que linea de tal archivo viene el codigo. "C:/TDM-GCC-64/x86_64-w64-mingw32/include/stdio.h" , del stdio.h
...
> **R:** Son el "prologo" de la funcion, el pushq y el movq manejan la memoria y los seh manejan posibles errores
...
> **R:** Porque en programa.c solo se llama a indefinida mientras que en matematica.c esta escrito el codigo
...
> **R:** Los que quedan solo son los de las bibliotecas dinamicas del sistema, sistema operativo se encarga de ellos cuando se vaya a ejecutar el programa
...
> **R:** La macro busca y reemplaza texto pero no tiene verificacion de tipos, y "desaparece" en el preprocesador, la funcion es codigoq ue se arma en la compilacion y tiene chequeo de tipos, y esta "desaparece" cuando su codigo se traduce a assembly en la compilacion
...
> **R:** La T son las funciones y esta en .text mientras uqe la D son las variables y se encuentran en .data
...
> **R:** Porque al ser comun entre muchos programas gcc la trae por defecto
